...
// Note: Table styling in v3 may need adjustments based on actual component structure
// Keeping v2-style selectors for now to maintain compatibility
...
export const Table = tableRecipe;
