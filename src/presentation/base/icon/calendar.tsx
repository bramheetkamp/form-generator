...
export const CalendarCheckedIcon = createIcon({
  displayName: 'Calendar',
  viewBox: '0 0 24 24',
  defaultProps: {fill: 'none', color: 'brand.500'},
  path: (
    <path
      fillRule={'evenodd'}
      clipRule={'evenodd'}
...
export const CalendarGreenCheckedIcon = createIcon({
  displayName: 'Calendar',
  viewBox: '0 0 24 24',
  defaultProps: {fill: 'none', color: 'green.500'},
  path: (
    <path
      fillRule={'evenodd'}
      clipRule={'evenodd'}
